...
alias vi="nvim"
alias vim="nvim -c 'Telescope find_filesnvim -c 'lua require(\"harpoon.ui\").nav_file(1)'; exit'"
alias nvim="nvim"
...
#source /home/stiwie/.scripts/t.sh
...
alias config="nvim /home/stiwie/.dotfiles -c 'Telescope find_filesnvim -c 'lua require(\"harpoon.ui\").nav_file(1)'; exit' "
